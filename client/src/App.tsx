...
function App() {
  ...
  return (
    <div className="mx-auto min-h-screen max-w-lg flex flex-col items-center p-4 gap-12">
      ...
      {data && data.length > 0 && (
      <div className="w-full lg:fixed lg:bottom-4 lg:right-4 lg:max-w-lg space-y-4">
